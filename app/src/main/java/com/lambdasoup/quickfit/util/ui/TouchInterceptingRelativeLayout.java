...
public class TouchInterceptingRelativeLayout extends RelativeLayout {
    ...
    @TargetApi(21)
    public TouchInterceptingRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (onTouchInterceptor != null) {
            onTouchInterceptor.onTouch(this, ev);
        }
        return ret;
    }
