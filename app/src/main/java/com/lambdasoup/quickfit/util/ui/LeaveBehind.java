...
public abstract class LeaveBehind extends ItemTouchHelper.SimpleCallback {
    ...
    public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        ...
        final boolean start = dX < 0 ? rtl : !rtl;
        ...
        getDefaultUIUtil().onDraw(c, recyclerView, leaveBehindViewHolder.swipableItemView, dX, dY, actionState, isCurrentlyActive);
    }

    @Override
    public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        LeaveBehindViewHolder leaveBehindViewHolder = (LeaveBehindViewHolder) viewHolder;
        getDefaultUIUtil().clearView(leaveBehindViewHolder.swipableItemView);
        leaveBehindViewHolder.hideLeaveBehinds();
    }

    public static class LeaveBehindViewHolder extends RecyclerView.ViewHolder {
        public final View swipableItemView;
        public final View leaveBehindEnd;
        public final View leaveBehindStart;

        public LeaveBehindViewHolder(View itemView, View swipableItemView, View leaveBehindEnd, View leaveBehindStart) {
            super(itemView);
            this.swipableItemView = swipableItemView;
